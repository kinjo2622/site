...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // MENUのJS
  let items = [
    ['Soki Soba', '1,200', '~Addictive slow-cooked tender pork ribs~'],
    ['Yushi Tofu Soba', '1,100', '~Island tofu with concentrated aroma and flavor~'],
    ['Asa Soba', '1,100', '~Fresh sea lettuce harvested from the Okinawan sea~'],
    ['Sanmai-niku Soba', '1,100', '~Pork belly simmered with Awamori, soy sauce, and sugar~'],
    ['Luxury Soba', '1,300', '~Double combo of Soki and Sanmai-niku pork~'],
  ];
